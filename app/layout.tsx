...
export const metadata: Metadata = {
	...
	keywords: "Learn React, Learn Tailwind, Learn Javascript, Learn Typescript",
	authors: [{ name: "Jacob Paris", url: "https://twitter.com/jacobmparis" }],
	openGraph: {
		title: "Jacob Paris",
		description: "Come check out my guides to make you better at building web applications.",
		url: "https://www.jacobparis.com",
		siteName: "Jacob Paris",
		locale: "en_US",
		type: "website",
		images: ["https://www.jacobparis.com/images/og.png"],
	},
	twitter: {
