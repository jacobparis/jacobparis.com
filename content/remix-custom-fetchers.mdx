...
if (fetcher.state === "idle") {
	return <button onClick={() => fetcher.submit({ foo: "bar" })}>Submit</button>
}
...
<Callout type="info">
	...
	Utils](https://github.com/sergiodxa/remix-utils#use-debounce-fetcher). I recommend you use that
