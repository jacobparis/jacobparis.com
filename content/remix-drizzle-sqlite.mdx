---
title: Add Drizzle ORM to Remix with SQLite and Fly.io
...
- When this file loads (on server startup), we're [running any pending migrations](https://orm.drizzle.team/kit-docs/overview#running-migrations).
